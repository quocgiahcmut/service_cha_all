...
namespace AssemblySystemWorkerService.ProtocolServices.MqttCore;
...
public class MqttClientHelper
{
    ...
    public async Task<MqttClientPublishResult> Publish(string topic, string payload, bool retain)
    {
